...
class GeminiPDFProcessor:
    ...
    def process_pdf(self, pdf_path: str) -> bool:
        try:
            ...
            print(f"Error details: {e}") # <-- Add this line
            import traceback
            traceback.print_exc() # <-- And this line for a full stack trace
            sys.exit() # or other graceful exit
...
def main_cli():
    ...
    if not google_api_key:
        google_api_key = "AIzaSyAjrFwbBzZrSeSkyF1ZZJSagaxO3J1tAa0"
        if not google_api_key:
    ...
    try:
        ...
        # Get PDF path
        pdf_path = r"C:\Users\abhay\Downloads\23c4b858-2b24-4d5a-a7b5-da6d755b8a48.pdf"
